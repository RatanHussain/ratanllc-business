				...
				<div className='overflow-x-auto rounded-2xl border border-gray-200 shadow-sm'>
					<table className='min-w-full text-sm text-gray-700'>
						<thead className='bg-gray-50'>
							<tr>
								<th className='px-6 py-4 text-left font-semibold hidden md:table-cell'>Rank</th>
								...
								Object.entries(summary.businesses)
									...
									.map((data, index) => (
										<tr
											...
											<td className='px-6 py-4 font-medium hidden md:table-cell'>{index + 1}</td>
											<td className='px-6 py-4 font-semibold text-gray-800'>
												{data.name}
											</td>
											<td className='px-6 py-4 text-center hidden md:table-cell'>{data.expense}</td>
											<td className='px-6 py-4 text-center hidden md:table-cell'>{data.credit}</td>
